...
from .serializers import ProductSerializer, CollectionSerializer, ReivewSerializer, CartSerializer, CartItemsSerializer, AddCartItemSerializer, UpdateCartItemSerializer, CustomerSerializer
...
class CartItemViewSet(ModelViewSet):
    ...
    # This method allows the serializer to use data that is passed in the parameters
    def get_serializer_context(self):
        return {'cart_id': self.kwargs.get('cart_pk_pk')}
